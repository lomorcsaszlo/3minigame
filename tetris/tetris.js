document.addEventListener('DOMContentLoaded', () => {
  ...
  function inovelo(i, horizont) {
    ...
    try {
      if (i < 20) {
        ...
        squares.forEach(element => {
          if (element.style.backgroundColor == "black") { //ha színezett ezen a ponton valami, az az is marad.
            element.classList.add("anyád")
          }
        })
  ...
  function right() {
    if (squares[parseInt(`${i}${horizont +3}`)].style.backgroundColor != "black" && horizont != 9) { //ugyan az, csak a másik oldal.
